...
def test_initiative_analytics_calculation(mock_initiatives, mock_teams, tmp_path):
    ...
    with patch("src.core.logic.mart_generator.InitiativeController") as MockInitCtrl, \
        ...
        mock_team_instance.get_members.side_effect = lambda t_id: mock_teams.get(f"{t_id}-members", [])
