...
def test_exporter_fetches_and_exports_enriched_data():
    ...
    with patch('src.core.logic.research_group_exporter.ResearchGroupController') as MockRgCtrl, \
         patch('src.core.logic.research_group_exporter.CampusController') as MockCampCtrl, \
         patch('src.core.logic.research_group_exporter.OrganizationController') as MockOrgCtrl:
        ...
        mock_group.to_dict.return_value = {"id": 10, "organization_id": 1, "campus_id": 2, "name": "Group A"}
        ...
        expected_data = [{
            ...
            "members": [
                {"id": 101, "name": "Alice", "role": "Researcher", "lattes_url": "http://lattes/alice", "emails": ["alice@example.com"]},
                {"id": 102, "name": "Bob", "role": "Líder", "lattes_url": "http://lattes/bob", "emails": ["bob@example.com"]}
            ],
            "leaders": [
                {"id": 102, "name": "Bob", "role": "Líder", "lattes_url": "http://lattes/bob", "emails": ["bob@example.com"]}
            ]
