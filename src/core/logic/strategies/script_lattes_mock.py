            ...
            "projetos_pesquisa": [
                {
                    ...
                    "ano_conclusao": "Atual",
                    "descricao": [
                        "Descrição: Projeto pesquisa mock. Situação: Em andamento. Natureza: Pesquisa."
                    ],
            ...
            "projetos_extensao": [
                {
                    ...
                    "ano_conclusao": "2023",
                    "descricao": [
                        "Descrição: Projeto extensão mock. Situação: Concluído. Natureza: Extensão."
                    ],
                    "integrantes": [{"nome": name, "papel": "Coordenador"}],
                }
            ],
            "projetos_desenvolvimento": [
                {
                    ...
                    "ano_conclusao": "Atual",
                    "descricao": [
                        "Descrição: Projeto dev mock. Situação: Em andamento. Natureza: Desenvolvimento."
                    ],
                    "integrantes": [{"nome": name, "papel": "Coordenador"}],
                }
            ],
