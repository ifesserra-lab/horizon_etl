...
from research_domain import ResearchGroupController, ResearchGroup, CampusController
            ...
            for group in groups:
                ...
                if hasattr(group, 'knowledge_areas'):
                    ...
                    group_dict['knowledge_areas'] = [
                        {"id": ka.id, "name": ka.name} 
                        for ka in group.knowledge_areas
                    ]
                ...
                if hasattr(group, 'members'):
                    ...
                    for tm in group.members:
                        ...
                        lattes = getattr(tm.person, 'lattes_url', None) if tm.person else None
                        
                        # Fetch Emails
                        # emails is a relationship to PersonEmail objects
                        email_list = []
                        if tm.person and hasattr(tm.person, 'emails') and tm.person.emails:
                        ...
                        if role_name and "leader" in role_name.lower() or "líder" in role_name.lower():
